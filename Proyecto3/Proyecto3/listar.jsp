   ...
   <i class="fas fa-exclamation-circle me-2"></i>
    ...
    <i class="fas fa-phone-alt text-muted me-2"></i>
                      ...
                      <td class="text-center">
                                        <%-- El enlace de modificar ahora usa el CargarContactoServlet y apunta al formulario unificado --%>
...
<i class="fas fa-edit"></i> Editar
                                        ...
                                        <%-- FIX de Seguridad: Uso de un formulario POST para la eliminación --%>
                                        <form method="post" action="EliminarContactoServlet" style="display:inline;" id="formEliminar-<%= contacto.getId() %>">
                                            <input type="hidden" name="id" value="<%= contacto.getId() %>">
                                            <button type="button" 
                                                    class="btn btn-action btn-delete"
                                                    title="Eliminar contacto"
                                                    onclick="confirmarYEliminar('<%= contacto.getNombre() %> <%= contacto.getApellido() %>', <%= contacto.getId() %>)">
...
if (noResultsRow) {
        ...
        // FIX de seguridad: Nueva función para confirmar y enviar el formulario POST
        function confirmarYEliminar(nombre, id) {
            ...
            if (confirmacion) {
                // Envía el formulario POST específico
